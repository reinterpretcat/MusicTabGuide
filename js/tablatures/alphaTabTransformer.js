...
MusicTab.Tablatures.AlphaTabTransformer = klass(null, {
    ...
    getTracks: function(body) {
        ...
        for (var i = 0; i < tracksCount; i++) {
            ...
            track.instrument = MusicTab.Tablatures.TransformHelper.getInstrument(body.tracks[i].channel._instrument);
    ...
    getBeat: function (beat) {
        ...
        return {
            duration: MusicTab.Tablatures.TransformHelper.getDurationString(beat.voices[0].duration),
...
MusicTab.Tablatures.AlphaTabTransformer.transform = function (tab, helper, success) {
    new MusicTab.Tablatures.AlphaTabTransformer(tab, helper, success);
};