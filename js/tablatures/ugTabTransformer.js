...
MusicTab.Tablatures.UgTabTransformer = klass(null, {
    ...
    getTracks: function (body) {
        ...
        for (var i = 0; i < tracksCount; i++) {
            ...
            track.instrument = MusicTab.Tablatures.TransformHelper.getInstrument(body.tracks[i].midiindex);
...
MusicTab.Tablatures.UgTabTransformer.transform = function (title, tab, helper, success) {
    new MusicTab.Tablatures.UgTabTransformer(title, tab, helper, success);
};