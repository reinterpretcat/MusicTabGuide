    ...
    ui.Pages.define(searchPageURI, {
        ...
        _initializeLayout: function (listView, viewState) {
            ...
            if (viewState === appViewState.snapped) {
                ...
                document.querySelector(".titlearea .pagetitle").textContent = "MusicTab Guide";
        ...
        _itemInvoked: function (args) {
            args.detail.itemPromise.done(function itemInvoked(item) {
                ...
                //nav.navigate("/pages/itemDetail/itemDetail.html ", { item: MusicTab.Data.getItemReference(item.data) });
                nav.navigate("/pages/stave/stave.html ", { item: MusicTab.Data.getItemReference(item.data) });
            });
        },
        ...
        _searchData: function (queryText) {
            var originalResults;
            if (MusicTab.Data) {
                originalResults = MusicTab.Data.items.createFiltered(function (item) {
                    if (item.title == undefined || queryText == undefined) return false;
